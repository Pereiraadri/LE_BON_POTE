...
p "Creating Buddies"
buddy = Buddy.new(first_name: "Gordon", last_name: "Bleu", email: "gordonbleu@gmail.com", skill: "Cuisinier", description: "Frétilleur de Papilles", address: "Lille", price: 250, user: user)
...
buddy1 = Buddy.new(first_name: "Amélie", last_name: "Lens", email: "amelielens@gmail.com", skill: "DJ", description: "Je vais te faire bouger le popotin comme personnee", address: "Paris", price: 700, user: user)
...
buddy2 = Buddy.new(first_name: "Ken",last_name: "Sanbarbie", email: "ken@gmail.com", skill: "Beau Gosse", description: "Par mon physique avantageux je vous met en lumière le temps de la location", address: "Grenoble", price: 150, user: user)
...
buddy3 = Buddy.new(first_name: "Bozo",last_name: "Leclown", email: "bozo@gmail.com", skill: "Clown", description: "j'anime les soirées comme personne, fin blagueur rigolade assurée", address: "Lyon", price: 100, user: user)
...
buddy4 = Buddy.new(first_name: "Joe",last_name: "Letaxi", email: "jesuistonsam@gmail.com", skill: "Taxi", description: "Celui qui conduit c'est celui qui ne boit pas", address: "Reims", price: 50, user: user)
...
buddy5 = Buddy.new(first_name: "Doodie",last_name: "Doo", email: "doodietatoo@gmail.com", skill: "Tatoueu(se)r", description: "Tatoueuse qui tatoue mieux que ton ex ne t’aimait !", address: "Nice", price: 150, user: user)
...
buddy6 = Buddy.new(first_name: "Lee",last_name: "Miller",email: "leemiller@gmail.com", skill: "Photographe/Vidéaste", description: "J'immortalise tout vos evenements", address: "Brest", price: 100, user: user)
...
buddy7 = Buddy.new(first_name: "Oui", last_name: "Oui", email: "ouiouitonami@gmail.com", skill: "Poto", description: "Une oreille attentive, un calineur hors pair", address: "Toulouse", price: 1, user: user)
